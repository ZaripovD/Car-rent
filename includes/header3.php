...
<body>
    ...
    <nav class="text-center" id="top_nav">
      <div class="row">
        <ul class="list-inline">
         <li><a href="index.php">
           Главная
         </a></li>
         <li><a href="assortment.php">
           Ассортимент
         </a></li>
         <li><a href="persarea.php">
           Личный кабинет
         </a></li>
         <li><a href="admin.php">
